...
def SCB_ADMM_python(X, nu1, nu2, nu3, gamma_1, gamma_2, gamma_3, w_l, u_k, feature_weight, niter, tol, output = 1):
    ...
    for iters in range(int(niter)):
        ...
        if output == 1:
            ...
            print('g_new - z_old: ' + str(round(np.mean(np.abs(g - g_old)),3)))
        ...
        if conditions:
            return(A, v, z, g, lambda_1, lambda_2, lambda_3, iters)
            break
